...
const News = (props) => {
  ...
  useEffect(() => {
    newsUpdate();
    document.title = `${capitalizeFirstLetter(props.category)} - DiggingNews`;
  ...
  return (
    <div className="container my-3">
      <h1
        ...
        style={{ marginTop: "95px", marginBottom: "15px", color: "#0dcaf0" }}
      >
      ...
      {/* Incase we wanted a Previous and NExt button */}
